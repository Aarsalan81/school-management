...
export default function DeleteCourse(props) {
    ...
    const {deleteCourse , setDeleteCourse , item , setIsSuccess} = props;
    ...
    const deleteItem = () => {
        ...
        axios.delete(
            `http://localhost:5000/api/courses/${item.courseID}`,
    ...
    return (
        <>
            <Dialog maxWidth="md" open={deleteCourse}>
                    ...
                    <DialogContent sx={{textAlign:"center"}}>
                        ...
                        <Typography sx={{marginTop:"10px" ,fontFamily:"medium" , fontSize:"1rem"}}>
                            آیا از حذف دوره ({item.tutorialName+" استاد "+item.teacherName}) مطمئن هستید ؟
                        </Typography>
                    </DialogContent>
                    <Divider variant='middle' />
                    <DialogActions>
                        <Button sx={{ fontFamily: "medium" }} variant='text' color='primary' onClick={() => setDeleteCourse(false) }>انصراف</Button>
