...
export default function DetailTeacher(props) {
    const { detailTeacher, setDetailTeacher, item } = props;

    return (
        <>
            <Dialog maxWidth="md" open={detailTeacher}>
                <div style={{backgroundColor:"#81D4FA"}}>
                    ...
                    <DialogActions>
                        ...
                        <Button sx={{ fontFamily: "medium" }} variant='contained' color='info' onClick={() => setDetailTeacher(false)}>بستن</Button>
