...
export default function UpdateTeacher(props) {
    const {editTeacher , setEditTeacher , item , setItem , setIsSuccess} = props;
    ...
    return (
        <>
            <Dialog maxWidth="md" open={editTeacher} onClose={() => setEditTeacher(false)}>
                <form onSubmit={formik.handleSubmit}>
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12}>
                                <Typography color="gray" fontSize={"1rem"} sx={{fontFamily:"medium"}}>
                                    لطفا اطلاعات استاد را تکمیل کنید.
                                </Typography>
                            </Grid>
                    ...
                    <DialogActions>
                        <Button sx={{ fontFamily: "medium" }} variant='contained' color='inherit' onClick={() => setEditTeacher(false)}>انصراف</Button>
